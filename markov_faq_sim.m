% MARKOV_FAQ_SIM = simulation with a Markov channel
...
q = zeros(100, length(rates)) / (1 - lambda);
...
for i = 1 : runs,
    ...
    [q, parallel_stats(1 + segments * (i - 1) : segments * i, :)] = episode(q, rates, segments, qualities, complexities, capacities, alpha, lambda, tau, 1, 1, 0);
...
q_online = q;
save('./Qmats/q_p1s2d5_on.mat','q_online')
